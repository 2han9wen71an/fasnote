...
layout: post
title:  "自建docker镜像源"
date:   2025-01-03 17:18:20 +0800
categories: 代码笔记 折腾笔记 生活随笔
permalink: /Toss-notes/65E2082B.html
tags: [docker]
---

**第①步：打开 [Cloudflare](https://www.cloudflare.com/) 官网**  

**第②步：在左侧列表中找到 Workers & Pages**  

![Workers & Pages](https://images.zvt.me/1736321296789.png)

**第③步：找到 Create 按钮**  

![Create 按钮](https://images.zvt.me/1736322627927.png)  

选择 Workers 然后点击 Create Workers  

![选择 Workers](https://images.zvt.me/1736322358695.png)  

**第④步：输入前缀**  

例如：`dockerproxy` （或其他容易记住的名称）  

![输入前缀](https://images.zvt.me/1736322368676.png)  

然后点击 Save 保存。  

![点击 Save](https://images.zvt.me/1736322707050.png)  

保存后会出现新页面，直接点击 Finish。  

点击 'Edit code' 开始编辑 `workers.js`  

![点击 Edit code](https://images.zvt.me/1736322725610.png)  

删除自带的内容。  

![删除自带内容](https://images.zvt.me/1736322743824.png)  
...
![修改自定义域名](https://images.zvt.me/1736322761680.png)

填写示例如下：

![填写示例](https://images.zvt.me/1736322779396.png)

然后点击右上角 Deploy 保存。

返回 Workers & Pages 设置页面。

![返回设置](https://images.zvt.me/1736324747468.png)

添加自定义域名，例如：`docker.zvt.me`

![添加自定义域名](https://images.zvt.me/1736322799933.png)
...
| 变量名   | 示例                      | 必填 | 备注                                                         |
| -------- | ------------------------- | ---- | ------------------------------------------------------------ |
| URL302   | `https://www.example.com` | 否   | 主页 302 跳转                                               |
| URL      | `https://www.baidu.com/`  | 否   | 主页伪装 (设为 `nginx` 则伪装为 nginx 默认页面)              |
| UA       | `netcraft`               | 否   | 支持多元素，元素之间使用空格或换行作间隔。用于屏蔽爬虫UA。 |

如果你想隐藏你的镜像站，可以设置伪装页面。

找到设置 -> 环境变量。

![找到环境变量](https://images.zvt.me/1736324800727.png)

**示例 1：将首页重定向到其他网站**

添加环境变量 `URL302` (必须大写)，值填写目标域名，例如 `https://www.baidu.com`

![URL302 示例](https://images.zvt.me/1736324818805.png)
...
![URL 示例](https://images.zvt.me/1736324841691.png)
...
```bash
docker pull 你的域名/stilleshan/frpc:latest
```

例如：

```bash
docker pull docker.zvt.me/stilleshan/frpc:latest
```
...
本文参考:<https://linux.do/t/topic/114345>